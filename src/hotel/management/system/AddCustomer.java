...
public class AddCustomer extends JFrame implements ActionListener{
    ...
    AddCustomer() {
        ...
        lblidt.setBounds(35, 80, 100, 20);
        lblidt.setFont(new Font("Raleway", Font.BOLD,20));
        add(lblidt);
        ...
        lblnumber.setFont(new Font("Raleway", Font.BOLD,20));
        add(lblnumber);
        ...
        lblroom.setFont(new Font("Raleway", Font.BOLD,20));
        add(lblroom);
